      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <nav className="flex items-center gap-2 overflow-x-auto whitespace-nowrap pb-1 md:pb-0 md:gap-4">
            <Link to="/admin" className="inline-flex rounded-full bg-slate-100 px-3 py-2 text-sm text-slate-700">Dashboard</Link>
            ...
            <Link to="/admin/products/pending" className="inline-flex rounded-full bg-slate-100 px-3 py-2 text-sm text-slate-700">Sản phẩm chờ</Link>

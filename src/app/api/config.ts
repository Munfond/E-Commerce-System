...
export const IMAGE_BASE_URL =
  (import.meta as unknown as { env?: Record<string, string | undefined> }).env?.VITE_IMAGE_BASE_URL ??
  'https://uuoizvekbqnjrtadpshx.supabase.co/storage/v1/object/public/products/';
